                        ...
                        <div class="card-body">
                            <form id="reg-form" action="update" method="POST">
                                 ...
                                 <div class="form-group">
                                    <label for="exampleInputPassword1">Enter Roll Number</label>
                                    <input  name="roll" type="text" class="form-control" id="exampleInputPassword1" placeholder="Roll number">
                                </div>
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (data.trim() === 'done')
                            {
                                ...
                                swal("Registered successfully..We are going to redirect to login page")
                                        .then((value) => {
                                            window.location = "Update_student.jsp"
                                        });
                            } else
                            {
